...
import { useBankAdjustments } from "@/hooks/useBankAdjustments";
...
import { AdjustBalanceDialog } from "@/components/banks/AdjustBalanceDialog";
import { BankLogsSheet } from "@/components/banks/BankLogsSheet";

export default function Banks() {
	const { banks, addBank, updateBank, deleteBank, isLoading } =
		useBudgetData();
	const {
		adjustments,
		adjustBalance,
	...
	const totalBalance = banks.reduce(
		(sum, bank) => sum + Number(bank.balance),
		0,
	);
