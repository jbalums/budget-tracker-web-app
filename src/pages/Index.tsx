				...
				<div className="container px-4">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mb-8 text-lg text-muted-foreground lg:text-xl">
							A beautiful, simple budget tracker to manage your
							income, expenses, and savings goals. Track multiple
							bank accounts, set budget limits, and never
							overspend again.
						</p>
			...
			<footer className="border-t border-border/50 py-8">
				<div className="container px-4">
					<div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
						...
						<p className="text-sm text-muted-foreground">
							©{currentYear} Budget Tracker. Your personal finance
							companion.
							<br />
							By{" "}
							<a
								href="https://www.joelbaluma.com"
								target="_blank"
